...
export default function AboutPage() {
    ...
    const naicsCodes = [
        ...
        {
            code: "541611",
            name: "ADMINISTRATIVE MANAGEMENT & GENERAL MANAGEMENT CONSULTING SERVICES",
        },
        { code: "541613", name: "MARKETING CONSULTING SERVICES" },
        {
            code: "541614",
            name: "PROCESS, PHYSICAL DISTRIBUTION, & LOGISTICS CONSULTING SERVICES",
        },
            ...
            <section className="relative min-h-[500px] sm:min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden bg-brand-blue">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
                    ...
                    <div className="text-center mb-8 sm:mb-12 md:mb-16">
                        ...
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-2 sm:mb-3">
                            Strategic consulting expertise trusted by leading
                            organizations across government, defense, aerospace,
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto">
                        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center">
                            <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-orange mb-1 sm:mb-2">
                                45+
                            </div>
                    ...
                    <div className="grid xl:grid-cols-3 gap-8 sm:gap-12 md:gap-16 xl:gap-20 items-start">
                        <div className="max-w-xl xl:col-span-1">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-base leading-relaxed">
                                We&apos;re a dynamic group of individuals who
                                are passionate about what we do and dedicated to
                        ...
                        <ul
                            role="list"
                            className="grid gap-x-4 sm:gap-x-6 md:gap-x-8 gap-y-6 sm:gap-y-8 md:gap-y-12 sm:grid-cols-2 xl:col-span-2"
                        >
                            ...
                            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 flex items-start justify-between rounded-t-xl sm:rounded-t-2xl">
                                <div className="flex items-center gap-3 sm:gap-4 md:gap-6 min-w-0 flex-1">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <p className="text-sm sm:text-base text-brand-orange font-medium truncate">
                                            {teamLeaders[selectedMember].role}
                                        </p>
                                    </div>
                                </div>
                                <button
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg leading-relaxed mb-6">
                            Across regions and borders around the globe, our
                            team of experts uses decades of industry-leading and
                            nationally recognized expertise to empower the
                            connections between people, ideas, and things.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg leading-relaxed">
                            From organizing independent producers in Afghanistan
                            into a business community competitive in a global
                            market, to leading graduate and executive education
                            through partnerships with top universities, we meet
                            client needs by drawing on a deep bench of experts
                            to analyze and execute strategic insights like no
            ...
            <section className="bg-gradient-to-r from-brand-blue to-brand-blue-dark py-8 sm:py-12 md:py-16 lg:py-20">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-white/90 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-2">
                        We partner with organizations to optimize supply chain
                        performance. Our seasoned team combines strategic
                        thinking with practical execution across government,
                        aerospace, defense, and commercial sectors.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-base max-w-2xl mx-auto">
                            Our certified capabilities across multiple industry
                            classifications
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {naicsCodes.map((item, index) => {
                            const { icon, color } = getNaicsIconWithColor(
                                item.code
                            );
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        <div
                                            className={`shrink-0 w-10 h-10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-all duration-300 ${bgColorClass} ${color}`}
                                        >
                                            {icon}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <div
                                                className={`${color} text-lg font-bold mb-1.5`}
                                            >
                                                {item.code}
                                            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-base mb-6">
                                Our team has delivered successful projects
                                across 45+ countries spanning six continents.
                            </p>
            ...
            <section className="bg-gradient-to-r from-brand-blue to-brand-blue-dark py-8 sm:py-12 md:py-16 lg:py-20">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-white/90 text-sm sm:text-base md:text-lg mb-5 sm:mb-6 md:mb-8 max-w-2xl mx-auto px-2">
                        Discover how our strategic supply chain expertise can
                    ...
                    >
                        ...
                        >
                            ...
                            <path
                                d="M5.904 10.803a.5.5 0 1 1-.707-.707L9.293 6H6.525a.5.5 0 1 1 0-1H10.5a.5.5 0 0 1 .5.5v3.975a.5.5 0 0 1-1 0V6.707z"
                                fill="#f68921"
                            />
                        </svg>
                    </Link>
